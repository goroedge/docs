...
![Ваш дом](house.png?fit=300x400#center) 
...
{{< icons/icon vendor=bootstrap name=7-circle-fill color=red >}} --- (по желанию заказчика) разработка полного комплекта документации на разработанную автоматизированную систему:
