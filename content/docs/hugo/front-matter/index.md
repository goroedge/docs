...
linktitle = 'Theme Relearn'
date = 2024-11-15T11:13:37+03:00
categories = 'docs'
series = 'hugo'
tags = 'documentation'
...
```
Выполнить команду для загрузки темы

```shell
hugo mod init example.com

```
где `example.com` реальный адрес сайта, на котором будет разворачиваться проект

Отредактировать файл `hugo.toml`
```toml
[module]
  [[module.imports]]
...
```
Проинициализировать `git` и клонировать репазиторий с темой
```shell
git init
git submodule add --depth 1 https://github.com/McShelby/hugo-theme-relearn.git themes/hugo-theme-relearn
```

Добавить в настройки название темы
...
Описание настроек темы для Hugo со всеми вариантами

Эту тему рассматриваю как вариант для создания статических сайтов с документацией
```toml
[params]
